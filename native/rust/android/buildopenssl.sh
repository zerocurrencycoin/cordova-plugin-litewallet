...
export ANDROID_NDK_HOME=/home/cryptoforge/Android/Sdk/ndk/21.1.6352462
...
./Configure --prefix=/$PWD/openssl-1.1.1e/aarch64  android-arm64 -D__ANDROID_API__=26
make -j$(nproc)
...
./Configure --prefix=/$PWD/openssl-1.1.1e/armv7  android-arm -D__ANDROID_API__=26
make -j$(nproc)
make -j$(nproc) install
...
./Configure --prefix=/$PWD/openssl-1.1.1e/x86  android-x86 -D__ANDROID_API__=26
make -j$(nproc)
make -j$(nproc) install
